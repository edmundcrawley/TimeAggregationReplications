...
global fix_var			= 9			/* 	4- Variances changing by age and participation correction. 6 waves 11 years. 
...
scalar a  = .9
global trans_param = a*10
scalar var_dQ = 2/a
scalar var_bardQ = (a *(1/3) +  (1-a*(2/3))  +  a*(1/3)  +  (1-a*(2/3)))
scalar var_dP = 2
scalar var_bardP = 5/3

scalar cov_dQ_LdQ = -1/a
scalar cov_bardQ_LbardQ = (-1 + a/3)

scalar cov_dQ_bardQ = 1
scalar cov_bardQ_dQL = -1/2
scalar cov_LbardQ_dQ = -1/2

scalar cov_dP_bardP = 3/2
...
global poststring = "het${het_elasticities}pi${use_pi}fv${fix_var}cons${consumption}TA${TA}a${trans_param}"
if ${medass}==1 {
