...
if $TA ==1 {
		...
		gen `eps_`j''	=	duc_duy - ( `k1'*`k5' * m_s_u1 * cov_dQ_bardQ  //Cov(q(1,t), qbar(1,t))
									...
									+(`k3'*`k8'+`k4'*`k7') * m_r_v1v2 * cov_dP_bardP );   //Cov(p(1,t), pbar(2,t))  //no measurement error  Checked 10-7  12
		...
		gen `eps_`j''	=	duc_duyw_lag - ( (`k1'*`k9') * l2_s_u1 * cov_bardQ_dQL     	// cov (q(1,t), qbar(1,t-2))
										 ...
										 + (`k1'*`k10' + `k2'*`k9') * l2_r_u1u2 * cov_bardQ_dQL   ); // cov(q(1,t), qbar(2,t-2)) then again but flipped.   CHECKED 10-7  23
